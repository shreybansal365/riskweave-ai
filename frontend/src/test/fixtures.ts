...
export const incidentDetail: IncidentDetail = {
  ...
  fusion_projection: {
    ...
    interaction_source_pairs: [
      {
        interaction_contribution_id: "d3333333-3333-5333-8333-333333333333",
        interaction_rule_code: "CORR_MFA_AMOUNT",
        display_order: 3,
        interaction_source_event_id: "cccccccc-cccc-5ccc-8ccc-cccccccccccc",
        interaction_source_transaction_id: "88888888-8888-5888-8888-888888888888",
        interaction_source_baseline_id: null,
        cyber_component: {
          contribution_id: "d1111111-1111-5111-8111-111111111111",
          category: "cyber_rule",
          rule_code: "CYBER_MFA_FAILED",
          label: "Failed MFA",
  ...
  session: {
    ...
    organizationally_trusted: true,
    customer_device_familiar: false,
    customer_familiarity: "new_to_behavioural_history",
    customer_familiarity_basis: "behavioural_baseline_known_device_ids",
    device_first_seen_at: "2026-07-12T09:30:00Z",
